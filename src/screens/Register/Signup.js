            ...
            <div>
                <div className="signupcontainer">
                    ...
                    <div className="registerform">
                        ...
                        <br/>
                        <span style={{ fontSize: 15, fontWeight: 500 }}>Enter your details below</span><br /><br /><br />
                        ...
                        <br /><br />
                        <button onClick={handleValidation} className="btnregister">Register</button><br /><br />
