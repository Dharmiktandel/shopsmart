...
const Dashboard = () => {
    ...
    <tr>
        ...
        <th style={{ padding: "10px", width: "5%", position: 'relative' }}>
            ...
            <img src={newProduct.imagePreviewUrl} alt="Product Preview" style={{ maxHeight: '100%', maxWidth:"100"}}/>
        ) : (
                ...
                <div>
                    <form style={{}}>
                        <table style={{
                            ...
                            <thead>
                                <tr style={{ borderLeft: 'none', borderRight: "none", borderBottomWidth: 2, borderColor: '#DEE2E6', }}>
                                    <th scope="col" style={{ width: '10%', padding: "10px" }}>OrderId</th>
                                    <th scope="col" style={{
                                        width: '35%', padding: "10px"
                                    }}>Product Name</th>
                                    <th style={{width:'15%',padding: "10px"}}>Price</th>
                                    <th style={{ padding: "10px",width:'20%' }} scope="col">Customer Name</th>
                            ...
                            <tbody>
                                <tr style={{ borderLeft: 'none', borderRight: "none", borderBottomWidth: 2, borderColor: '#DEE2E6' }}>
                                    ...
                                    <td style={{ padding: "10px" }}>
                                        <div>
                                            <img style={{ height: 25, width: 25 }} src={uo} alt="ll"></img>&nbsp;
                                            <span>Smart Watch</span>
                                        </div>
                                    </td>
                                    <td  style={{ padding: "10px" }}>345</td>
                                    <td style={{ padding: "10px" }}>Dharmik Tandel</td>
                                    <td style={{  padding: "10px",textAlign:"right" }}>9924423267</td>
                                </tr>
        ...
        <div style={{ display: "flex", height: "100vh", flexDirection: 'column' }}>
            ...
            <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "row", marginLeft: 20 }}>
                    <img style={{ height: 25, width: 25 }} src={vendorAccount.productimage ? URL.createObjectURL(vendorAccount.productimage) : 'defaultImagePath.jpg'} alt="store"></img>&nbsp;&nbsp;
                ...
                <div style={{ marginRight: 50,fontSize:15,fontWeight:550 }}>
                    ...
                    <button onClick={handleLogout} style={{border:"none",backgroundColor:"blue",height:30,width:80}}>Logout</button>
                </div>
            </div>
